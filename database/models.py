...
class VisitedSite(db.Model):
    ...
    sessions = relationship(
        "Session",
        secondary=site_sessions,
        back_populates="visited_sites"
    )
...
class Session(db.Model):
    ...
    def register_user_interaction(self, eventType: str, eventDetails: JSON) -> "Interaction":
        """
        ...
        if eventType == "tab_created" and isinstance(eventDetails, dict) and "url" in eventDetails:
